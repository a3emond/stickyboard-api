...
-- ============================================================================
-- FAST DEV SEED (safe to keep; remove in prod if undesired)
-- ============================================================================
INSERT INTO users (id,email,display_name) VALUES
  ('00000000-0000-0000-0000-000000000001','demo@sticky.local','Demo User')
ON CONFLICT DO NOTHING;

INSERT INTO workspaces (id,name,created_by) VALUES
  ('10000000-0000-0000-0000-000000000001','Personal','00000000-0000-0000-0000-000000000001')
ON CONFLICT DO NOTHING;
...
INSERT INTO boards (id,workspace_id,title,created_by) VALUES
  ('20000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000001','Demo Board','00000000-0000-0000-0000-000000000001')
ON CONFLICT DO NOTHING;

INSERT INTO views (id,board_id,title,type,position) VALUES
  ('30000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000001','Kanban','kanban',0),
  ('30000000-0000-0000-0000-000000000002','20000000-0000-0000-0000-000000000001','List','list',1),
  ('30000000-0000-0000-0000-000000000003','20000000-0000-0000-0000-000000000001','Doc','doc',2)
ON CONFLICT DO NOTHING;

INSERT INTO cards (id,board_id,title,markdown,created_by) VALUES
  ('40000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000001','Welcome','**Hello StickyBoard!**','00000000-0000-0000-0000-000000000001')
ON CONFLICT DO NOTHING;
