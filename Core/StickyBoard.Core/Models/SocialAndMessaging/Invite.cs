...
public class Invite : IEntity
{
    ...
    [Column("scope_type")] public InviteScope ScopeType { get; set; }

    [Column("workspace_id")] public Guid? WorkspaceId { get; set; }

    [Column("board_id")] public Guid? BoardId { get; set; }

    [Column("contact_id")] public Guid? ContactId { get; set; }

    [Column("target_role")] public WorkspaceRole? TargetRole { get; set; }

    [Column("board_role")] public WorkspaceRole? BoardRole { get; set; }
